    ...
    <section className={styles.greeting}>
      ...
      <ul className={styles["greeting__experience-list"]}>
        <li className={styles["greeting__experience-item"]}>
          ...
          <p>
            Прохождение образовательной программы компании. Работа в команде над проектом
            по изучению иностранного языка Lang.
          </p>
        </li>
        <li className={styles["greeting__experience-item"]}>
          <h3 className={styles["greeting__experience-subtitle"]}>
          ...
          <p>
            ...
            как React + Redux и Vue 3. Прошел восьмимесячный курс от компании
            EPAM на сертификат по frontend разработке.
          </p>
        </li>
        <li className={styles["greeting__experience-item"]}>
          <h3 className={styles["greeting__experience-subtitle"]}>
